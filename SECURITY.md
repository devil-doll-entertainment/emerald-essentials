...
If you find a security vulnerability in **Emerald Essentials**, report it privately before disclosing it publicly.

**Preferred channel:**
Email — `legal.sxnnyside@sxnnysideproject.com`

**Alternative:**
[GitHub Private Security Advisory](https://github.com/devil-doll-entertainment/emerald-essentials/security/advisories/new)
